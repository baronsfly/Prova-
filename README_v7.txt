PilotLog 7.0.0 — CENTRAL DATABASE EDITION
...
FIRST CLEAN START
1. Install/open PilotLog 7.0.0 on the device chosen to initialize the new database.
...
9. On every other device, install PilotLog 7.0.0, use “Reset Local Cache Only”, sign in, and Sync now. With no local pending changes, the device downloads the central database and replaces its cache.
