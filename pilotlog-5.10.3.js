...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  $('aerolineRosterFile').addEventListener('change',async e=>{
    ...
    try{
      ...
      autoDetectTrips(false);await render();renderDuty();scheduleAutoSync('aeroline-roster-import');
