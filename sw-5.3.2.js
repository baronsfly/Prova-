const CACHE='pilotlog-v5.3.2';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-5.3.2.css',self.location).href,new URL('./pilotlog-5.3.2.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
