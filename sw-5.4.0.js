const CACHE='pilotlog-v5.4.0';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-5.4.0.css',self.location).href,new URL('./pilotlog-5.4.0.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
