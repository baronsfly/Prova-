...
function logTenMonthCreditMins(month){
  // Historical LogTen Custom Time totals are intentionally ignored in v8.4.1.
...
async function importLogTenMigrationPackage(file){
  ...
  if(manifest.creditHoursOnlyPatch===true){
    throw new Error('Credit-Hours-only LogTen patches are not used in v8.4.1. Flight Credit H is calculated automatically from Scheduled Block Hours.');
  }
