const CACHE='pilotlog-v5.10.3';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-5.10.3.css',self.location).href,new URL('./pilotlog-5.10.3.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
