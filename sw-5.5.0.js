const CACHE='pilotlog-v5.5.0';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-5.5.0.css',self.location).href,new URL('./pilotlog-5.5.0.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
