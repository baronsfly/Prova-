const CACHE='pilotlog-v6.0.4';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-6.0.4.css',self.location).href,new URL('./pilotlog-6.0.4.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
