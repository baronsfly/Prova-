const CACHE='pilotlog-v6.0.5';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-6.0.5.css',self.location).href,new URL('./pilotlog-6.0.5.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
